...
const LecCalendar = () => {
  //Get the modulename from localstorage
  let lecmodulename = localStorage.getItem("lectureModulename");
  // console.log("Lectutureeeeer", lecmodulename);
    ...
    if (selectedDate) {
      ...
      const events = allCalendar.filter(
        (single) =>
          ...
          single.modulename === lecmodulename.trim()
      );
